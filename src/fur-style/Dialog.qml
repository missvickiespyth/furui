...
T.Dialog {
    ...
    padding: FurUI.Theme.hugeRadius
    ...
    header: Item {
        id: _headerItem
        implicitHeight: _headerLabel.visible ? _headerLabel.implicitHeight + FurUI.Units.largeSpacing : 0
    ...
    footer: DialogButtonBox {
        visible: count > 0
        padding: FurUI.Units.largeSpacing * 2
    }
}