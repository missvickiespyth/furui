...
Window {
    ...
    property var borderColor: windowHelper.compositing ? FurUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.3)
                                                                  : Qt.rgba(0, 0, 0, 0.2) : FurUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.1)
                                                                                                                  : Qt.rgba(0, 0, 0, 0.05)
    flags: Qt.WindowStaysOnTopHint | Qt.WindowDoesNotAcceptFocus | Qt.ToolTip
    width: label.implicitWidth + FurUI.Units.largeSpacing * 1.5
    height: label.implicitHeight + FurUI.Units.largeSpacing * 1.5
    ...
    Rectangle {
        id: _background
        anchors.fill: parent
        color: FurUI.Theme.secondBackgroundColor
        radius: windowHelper.compositing ? FurUI.Theme.mediumRadius : 0
    ...
    function adjustCorrectLocation() {
        ...
        if (posX <= Screen.virtualX)
            posX = Screen.virtualX + FurUI.Units.smallSpacing

        // top
        if (posY <= Screen.virtualY)
            posY = Screen.virtualY + FurUI.Units.smallSpacing
