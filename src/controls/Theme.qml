...
import QtQuick 2.4
import FurUI.Core 1.0 as FurUICore

QtObject {
    id: theme

    property real devicePixelRatio: FurUICore.ThemeManager.devicePixelRatio

    property bool darkMode: FurUICore.ThemeManager.darkMode

    property color blueColor: FurUICore.ThemeManager.blueColor
    property color redColor: FurUICore.ThemeManager.redColor
    property color greenColor: FurUICore.ThemeManager.greenColor
    property color purpleColor: FurUICore.ThemeManager.purpleColor
    property color pinkColor: FurUICore.ThemeManager.pinkColor
    property color orangeColor: FurUICore.ThemeManager.orangeColor
    property color greyColor: FurUICore.ThemeManager.greyColor
    ...
    property color highlightColor: FurUICore.ThemeManager.accentColor
    ...
    property real fontSize: FurUICore.ThemeManager.fontSize
    property string fontFamily: FurUICore.ThemeManager.fontFamily
