...
Popup {
    ...
    y: parent.height - height - FurUI.Units.largeSpacing
    ...
    leftPadding: FurUI.Units.smallSpacing
    rightPadding: FurUI.Units.smallSpacing
    bottomPadding: FurUI.Units.largeSpacing
    ...
    Component {
        ...
        Control {
            ...
            topPadding: FurUI.Units.largeSpacing
            bottomPadding: FurUI.Units.largeSpacing
            ...
            contentItem: RowLayout {
                ...
                Label {
                    id: label
                    Layout.maximumWidth: Math.min(control.parent.width - FurUI.Units.largeSpacing * 4, implicitWidth)
